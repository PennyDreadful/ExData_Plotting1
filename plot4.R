...
par(mfrow = c(2,2))
plot(Global_active_power ~ FormattedTime, data = dt.interval, ylab = "Global Active Power", type = "l", xlab = "")

plot(Voltage ~ FormattedTime, data = dt.interval, type = "l", xlab = "datetime")
...
plot(Global_reactive_power ~ FormattedTime, data = dt.interval, type = "l", xlab = "datetime")
